...
public class JWEventHandler implements
    ...
    public JWEventHandler(JWPlayerView jwPlayerView, TextView output, ScrollView scrollview) {
        ...
        mPlayer.addOnSharingClickListener(this);
        mPlayer.addOnSharingCloseListener(this);
        mPlayer.addOnSharingOpenListener(this);
    ...
    public void onAudioTracks(AudioTracksEvent audioTracksEvent) {
        updateOutput(" onAudioTracks " + audioTracksEvent.getLevels().size());
        print(" onAudioTracks " + audioTracksEvent.getLevels().size());
    }
...
//        print(" onTime);
    ...
    public void onSharingClick(SharingClickEvent sharingClickEvent) {
        updateOutput(" onSharingClick method: " + sharingClickEvent.getMethod());
        print(" onSharingClick method: " + sharingClickEvent.getMethod());
    }

    @Override
    public void onSharingClose(SharingCloseEvent sharingCloseEvent) {
        updateOutput(" onSharingClose");
        print(" onSharingClose");

    }

    @Override
    public void onSharingOpen(SharingOpenEvent sharingOpenEvent) {
        updateOutput(" onSharingOpen ");
        print(" onSharingOpen ");
